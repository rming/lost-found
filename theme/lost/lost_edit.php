    ...
    <div class="content">
    	...
    	<div class="list" >
        	<div class="find_title font_heiti " >
            	<a href="<?php echo  site_url('user/lost/1')?>">更新遗失信息</a>
            </div>
            ...
            <div class="post_form">
				...
				<li><span class="post_t">遗失地点：</span><span class="post_c"><?php echo form_input('place',$place); ?><?php echo form_error('place');?><font size="-1" color="red">(*)</font></span></li>
				...
				<li><span class="post_t"></span><span class="post_c"   style="margin-top:5px;"><?php echo form_submit('submit','更新信息',"id=\"subBtn\" ");?></span></li>
				<?php echo form_close(); ?>
			</ul>
           </div>
        </div>
