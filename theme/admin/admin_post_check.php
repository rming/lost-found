    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/post/check')?>" selected="selected">-选择分类-</option>
	    					<option value="<?php echo site_url('admin/post/check/lost')?>" >&nbsp;遗失信息</option>
	    					<option value="<?php echo site_url('admin/post/check/found')?>" >&nbsp;招领信息</option>
	    					</select>
    					</div>
    				</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/post/check'); ?>"  class="nav_hover">信息审核</a></li>
