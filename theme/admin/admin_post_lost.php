    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/post/lost')?>" selected="selected">-物品分类-</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=0"?>" >&nbsp;书籍资料</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=1"?>" >&nbsp;衣服饰品</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=2"?>" >&nbsp;交通工具</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=3"?>" >&nbsp;随身物品</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=4"?>" >&nbsp;电子数码</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=5"?>" >&nbsp;卡类证件</option>
	    					<option value="<?php echo site_url('admin/post/lost')."?tid=6"?>" >&nbsp;其他物品</option>
	    					</select>
    					</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/post/lost'); ?>"  class="nav_hover">遗失信息</a></li>
