    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/post/out')?>" selected="selected">-选择分类-</option>
	    					<option value="<?php echo site_url('admin/post/out/lost')?>" >&nbsp;遗失信息</option>
	    					<option value="<?php echo site_url('admin/post/out/found')?>" >&nbsp;招领信息</option>
	    					</select>
    					</div>
    				</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/post/out'); ?>"  class="nav_hover">失效信息</a></li>
