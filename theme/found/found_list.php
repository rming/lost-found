    	...
    	<div class="list">
        	<div class="lost_title font_heiti">
                ...
                <div class="cateselect">
    				...
    				<option value="<?php echo site_url('found')?>" selected="selected">-物品分类-</option>
    				<option value="<?php echo site_url('found')."?tid=0"?>" >&nbsp;书籍资料</option>
    				<option value="<?php echo site_url('found')."?tid=1"?>" >&nbsp;衣服饰品</option>
    				<option value="<?php echo site_url('found')."?tid=2"?>" >&nbsp;交通工具</option>
    				<option value="<?php echo site_url('found')."?tid=3"?>" >&nbsp;随身物品</option>
    				<option value="<?php echo site_url('found')."?tid=4"?>" >&nbsp;电子数码</option>
    				<option value="<?php echo site_url('found')."?tid=5"?>" >&nbsp;卡类证件</option>
    				<option value="<?php echo site_url('found')."?tid=6"?>" >&nbsp;其他物品</option>
    				</select>
    			</div>
            </div>
