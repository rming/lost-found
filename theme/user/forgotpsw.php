    	...
    	<div class="list">
            ...
            <div class="sign_form">
	           ...
	           <div class="align_center"><?php  echo @$error;?></div>
				<?php echo form_open(site_url('user/forgotpsw'));?>
				<li><span class="detail_t">邮箱地址：</span><span class="detail_c sign_input"><?php echo form_input('email');?><?php echo form_error('email');?></span></li>
				...
				<li style="width:280px;"><?php echo form_submit('submit','找回密码','class="login_submit" style="width:80px;"');?></li>
				<?php echo form_close(); ?>
	           </ul>
           </div>
		    </div>
