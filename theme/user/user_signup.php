    ...
    <div class="content">
    	...
    	<div class="list">
        	<div class="login_title font_heiti ">
            	<a href="<?php echo  site_url('user/signup')?>">用户登录</a>
                <a href="<?php echo  site_url('user/login')?>" target="_blank"  class="go_another">=>去登录页面</a>
            </div>
            <div class="sign_form">
	           <ul class="detail">
	           <div class="align_center"><?php  echo @$error;?></div>
				<?php echo form_open('user/signup');?>
				<li><span class="detail_t">同户名：</span><span class="detail_c sign_input"><?php echo form_input('name',set_value('name'));?><?php echo form_error('name'); ?><?php  echo @$user_error ;?></span></li>
				<li><span class="detail_t">邮箱地址：</span><span class="detail_c sign_input"><?php echo form_input('email',set_value('email'));?><?php echo form_error('email');?></span></li>
				<li><span class="detail_t">&nbsp;&nbsp;密码：</span><span class="detail_c sign_input"><?php echo form_password('password');?><?php echo form_error('password');?></span></li>
				<li><span class="detail_t">重复密码：</span><span class="detail_c sign_input"><?php echo form_password('passconf');?><?php echo form_error('passconf');?></span></li>
				...
				<li style="width:280px;"><?php echo form_submit('submit','注册','class="login_submit"');?><?php echo anchor('user/login','登陆','class="sign_login"');?></li>
				<?php echo form_close(); ?>
	           </ul>
           </div>
		    </div>
