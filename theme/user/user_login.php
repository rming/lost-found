    ...
    <div class="content">
    	...
    	<div class="list" >
            ...
            <div class="login_form">
				...
				<div class="login_t">同户名：</div><div class="login_c" ><?php echo form_input('name',set_value('name')); ?></div>
				<div class="login_t">&nbsp;&nbsp;密码：</div><div class="login_c" ><?php echo form_password('password');?></div>
				...
				<?php echo form_submit('submit','登陆','class="login_submit"');?><?php echo anchor('user/signup','注册','class="login_sign"');?><a href="<?php echo site_url('user/forgotpsw');?>" style="font-size:12px;line-height:24px;margin-left:3px;color:red;">忘记密码？</a>
				<?php echo form_close(); ?>
			</div>
    	</div>
