    ...
    <div class="content">
    	...
    	<div class="list">
        	<div class="lost_title font_heiti">
            	<a href="<?php echo  site_url('user/found/1')?>"><?php echo $this->session->userdata('name');?>的招领信息</a>
                <div class="cateselect">
    				<select name="select" onchange="location.href=this.options[this.selectedIndex].value;" >
    				<option value="<?php echo site_url('user/found/1')?>" selected="selected">-状态分类-</option>
    				<option value="<?php echo site_url('user/found/1')."?status=0"?>" >&nbsp;正在审核</option>
    				<option value="<?php echo site_url('user/found/1')."?status=1"?>" >&nbsp;审核通过</option>
    				<option value="<?php echo site_url('user/found/1')."?status=2"?>" >&nbsp;已经失效</option>
    				</select>
    			</div>
            </div>
           <table width="822" border="0" class="table_post" style="margin-left:5px;_margin-left:3px;">
             ...
             <div class="pagenav"><?php  echo @$found_nav;  echo @$error;?></div>
