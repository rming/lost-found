    ...
    <div class="content">
    	...
    	<div class="list" >
        	<div class="find_title font_heiti " >
            	<a href="<?php echo  site_url('user/found')?>">发布招领信息</a>
                <a href="<?php echo  site_url('user/lost')?>" target="_blank"  class="go_another">=>发布遗失信息</a>
            </div>
            ...
            <div class="post_form">
				...
				<li><span class="post_t">拾获地点：</span><span class="post_c"><?php echo form_input('place',set_value('place')); ?><?php echo form_error('place');?><font size="-1" color="red">(*)</font></span></li>
